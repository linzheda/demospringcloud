...
public class MybatisPlusGenerator {
    ...
    public static void main(String[] args) {
        ...
        String projectPath = System.getProperty("user.dir")+"/unified-auth";
        ...
        try {
            FileInputStream in =new FileInputStream(projectPath +"/src/main/resources/generator.properties");
        ...
        pc.setParent("com.linzd.unifiedauth");
